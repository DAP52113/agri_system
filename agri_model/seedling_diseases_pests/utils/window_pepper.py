...
# 添加一个关于界面
# 窗口主类
# todo 添加数据库和模型保存的功能，模型保存的功能都添加一下把
...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        ...
        self.model = self.model_load(weights="runs/train/exp_transformer/weights/best.pt",
        ...
        if source == "":
            ...
            for path, im, im0s, vid_cap, s in dataset:
                ...
                for i, det in enumerate(pred):  # per image
                    ...
                    image_name = s.split(": ")[0].split("1 ")[-1]
                    state = s.split(": ")[1]
                    insert_data(image_name=image_name, location="北大街", state=state)
                    ...
                    QMessageBox.information(self, "success", "检测结果已输入数据库！")
