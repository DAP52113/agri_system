...
class Model(nn.Module):
    def __init__(self, cfg='yolov5s_mobilenetV3.yaml', ch=3, nc=None, anchors=None):  # model, input channels, number of classes
        super().__init__()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='yolo_GD.yaml', help='model.yaml')
