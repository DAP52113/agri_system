...
@torch.no_grad()
def run(data=ROOT / 'data/my_data.yaml',  # 'dataset.yaml path'
        weights=ROOT / 'runs/train/exps/weights/best.pt',  # weights path
...
def parse_opt():
    ...
    parser.add_argument('--weights', type=str, default=ROOT / 'runs/train/exps/weights/best.pt', help='weights path')
