...
# todo 修改为你的数据的根目录
FILE_ROOT = "F:/new_project/02mai/wheat/"
...
DEST_PPP = FILE_ROOT + "wheat_yolo_format"
DEST_IMAGES_PATH = "wheat_yolo_format/images"  # 区分训练集、测试集、验证集的图片目标路径
DEST_LABELS_PATH = "wheat_yolo_format/labels"  # 区分训练集、测试集、验证集的标签文件目标路径
...
def get_xml_data(file_path, img_xml_file):
    ...
    img_h, img_w, c = cv2.imread(osp.join(IMAGE_PATH, img_jpg_file_name)).shape
