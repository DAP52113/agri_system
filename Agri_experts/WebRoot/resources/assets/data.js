var provinceList = [{
	...
	},
	{
		...
		cityList: [{
			...
			{
				name: '东莞市',
				areaList: ['石龙镇', '石排镇', '茶山镇', '企石镇', '桥头镇', '东坑镇', '横沥镇', '常平镇', '虎门镇', '长安镇', '沙田镇', '厚街镇', '寮步镇', '大岭山镇',
					'大朗镇', '黄江镇', '樟木头镇', '谢岗镇', '塘厦镇', '清溪镇', '凤岗镇', '麻涌镇', '中堂镇', '高埗镇', '石碣镇', '望牛墩镇', '洪梅镇', '道滘镇'
				]
			},
			{
				name: '中山市',
				areaList: ['石岐街道', '东区街道', '西区街道', '南区街道', '五桂山街道', '火炬开发区', '黄圃镇', '南头镇', '东凤镇', '阜沙镇', '小榄镇', '东升镇', '古镇镇',
					'横栏镇', '三角镇', '民众镇', '南朗镇', '港口镇', '大涌镇', '沙溪镇', '三乡镇', '板芙镇', '神湾镇', '坦洲镇'
				]
			},
			{
				name: '潮州市',
	...
	},
	{
		...
		cityList: [{
				name: '石家庄市',
				areaList: ['长安区', '桥东区', '桥西区', '新华区', '井陉矿区', '裕华区', '井陉县', '正定县', '栾城县', '行唐县', '灵寿县', '高邑县', '深泽县', '赞皇县',
					'无极县', '平山县', '元氏县', '赵　县', '辛集市', '藁城市', '晋州市', '新乐市', '鹿泉市'
				]
			},
			{
				name: '唐山市',
			...
			{
				name: '邯郸市',
				areaList: ['邯山区', '丛台区', '复兴区', '峰峰矿区', '邯郸县', '临漳县', '成安县', '大名县', '涉　县', '磁　县', '肥乡县', '永年县', '邱　县', '鸡泽县',
					'广平县', '馆陶县', '魏　县', '曲周县', '武安市'
				]
			},
			{
				name: '邢台市',
				areaList: ['桥东区', '桥西区', '邢台县', '临城县', '内丘县', '柏乡县', '隆尧县', '任　县', '南和县', '宁晋县', '巨鹿县', '新河县', '广宗县', '平乡县',
					'威　县', '清河县', '临西县', '南宫市', '沙河市'
				]
			},
			{
				name: '保定市',
				areaList: ['新市区', '北市区', '南市区', '满城县', '清苑县', '涞水县', '阜平县', '徐水县', '定兴县', '唐　县', '高阳县', '容城县', '涞源县', '望都县',
					'安新县', '易　县', '曲阳县', '蠡　县', '顺平县', '博野县', '雄　县', '涿州市', '定州市', '安国市', '高碑店市'
				]
			},
			{
				name: '张家口市',
				areaList: ['桥东区', '桥西区', '宣化区', '下花园区', '宣化县', '张北县', '康保县', '沽源县', '尚义县', '蔚　县', '阳原县', '怀安县', '万全县', '怀来县',
					'涿鹿县', '赤城县', '崇礼县'
				]
			},
			{
			...
			{
				name: '沧州市',
				areaList: ['新华区', '运河区', '沧　县', '青　县', '东光县', '海兴县', '盐山县', '肃宁县', '南皮县', '吴桥县', '献　县', '孟村回族自治县', '泊头市', '任丘市',
					'黄骅市', '河间市'
				]
			},
			{
	...
	},
	{
		...
		cityList: [{
			...
			{
				name: '洛阳市',
				areaList: ['老城区', '西工区', '廛河回族区', '涧西区', '吉利区', '洛龙区', '孟津县', '新安县', '栾川县', '嵩　县', '汝阳县', '宜阳县', '洛宁县', '伊川县',
					'偃师市'
				]
			},
			{
	...
	},
	{
		...
		cityList: [{
			...
			{
				name: '临汾市',
				areaList: ['尧都区', '曲沃县', '翼城县', '襄汾县', '洪洞县', '古　县', '安泽县', '浮山县', '吉　县', '乡宁县', '大宁县', '隰　县', '永和县', '蒲　县',
					'汾西县', '侯马市', '霍州市'
				]
			},
			{
	...
	},
	{
		...
		cityList: [{
			...
			{
				name: '赣州市',
				areaList: ['章贡区', '赣　县', '信丰县', '大余县', '上犹县', '崇义县', '安远县', '龙南县', '定南县', '全南县', '宁都县', '于都县', '兴国县', '会昌县',
					'寻乌县', '石城县', '瑞金市', '南康市'
				]
			},
			{
	...
	},
	{
		...
		cityList: [{
				name: '哈尔滨市',
				areaList: ['道里区', '南岗区', '道外区', '香坊区', '动力区', '平房区', '松北区', '呼兰区', '依兰县', '方正县', '宾　县', '巴彦县', '木兰县', '通河县',
					'延寿县', '阿城市', '双城市', '尚志市', '五常市'
				]
			},
			{
	...
	},
	{
		...
		cityList: [{
				name: '成都市',
				areaList: ['锦江区', '青羊区', '金牛区', '武侯区', '成华区', '龙泉驿区', '青白江区', '新都区', '温江县', '金堂县', '双流县', '郫　县', '大邑县', '蒲江县',
	...
	},
	{
		...
		cityList: [{
			...
			{
				name: '遵义市',
				areaList: ['红花岗区', '汇川区', '遵义县', '桐梓县', '绥阳县', '正安县', '道真仡佬族苗族自治县', '务川仡佬族苗族自治县', '凤冈县', '湄潭县', '余庆县', '习水县',
					'赤水市', '仁怀市'
				]
			},
			{
	...
	},
	{
		...
		cityList: [{
				name: '昆明市',
				areaList: ['五华区', '盘龙区', '官渡区', '西山区', '东川区', '呈贡县', '晋宁县', '富民县', '宜良县', '石林彝族自治县', '嵩明县', '禄劝彝族苗族自治县',
					'寻甸回族彝族自治县', '安宁市'
				]
			},
			{
			...
			{
				name: '思茅市',
				areaList: ['翠云区', '普洱哈尼族彝族自治县', '墨江哈尼族自治县', '景东彝族自治县', '景谷傣族彝族自治县', '镇沅彝族哈尼族拉祜族自治县', '江城哈尼族彝族自治县', '孟连傣族拉祜族佤族自治县',
					'澜沧拉祜族自治县', '西盟佤族自治县'
				]
			},
			{
	...
	},
	{
		...
		cityList: [{
			...
			{
				name: '桂林市',
				areaList: ['秀峰区', '叠彩区', '象山区', '七星区', '雁山区', '阳朔县', '临桂县', '灵川县', '全州县', '兴安县', '永福县', '灌阳县', '龙胜各族自治县', '资源县',
					'平乐县', '荔蒲县', '恭城瑶族自治县'
				]
			},
			{
	...
	},
	{
		...
		cityList: [{
			...
			{
				name: '新界',
				areaList: ['北区', '离岛区', '西贡区', '沙田区', '大埔区', '荃湾区', '元朗区', '屯门区', '葵青区']
			}
		]
	},
	{
	...
	},
	{
		...
		cityList: [{
				name: '台北区域',
				areaList: ['台北市', '基隆市', '新北市', '桃园市', '新竹市', '宜兰县', '新竹县']
			},
			{
				name: '台中区域',
				areaList: ['苗栗县', '台中市', '彰化县', '南投县', '嘉义市', '花莲县', '云林县', '嘉义县']
			},
			{
				name: '台南区域',
